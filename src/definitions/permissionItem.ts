...
export interface IPermissionItem {
   ...
   *
   * Currently, there are 3 permission owner types, {@link AppResourceType.Workspace}, {@link AppResourceType.Folder}, and {@link AppResourceType.File}. If the type is {@link AppResourceType.Workspace}, `permissionOwnerId` will be the workspace's ID, if the type is {@link AppResourceType.Folder}, `permissionOwnerId` will be the folder's ID, and if the type is {@link AppResourceType.File}, `permissionOwnerId` will be the file's ID.
   */
   ...
   *
   * Currently, there are 4 permission entity types, {@link AppResourceType.User}, {@link AppResourceType.ProgramAccessToken}, {@link AppResourceType.ClientAssignedToken}, and {@link AppResourceType.PermissionGroup}. If the type is {@link AppResourceType.User}, `permissionEntityId` will be the user's ID, if the type is {@link AppResourceType.ProgramAccessToken}, `permissionEntityId` will be the token's ID, if the type is {@link AppResourceType.ClientAssignedToken}, `permissionEntityId` will be the token's ID, and if the type is {@link AppResourceType.PermissionGroup}, `permissionEntityId` will be the permission group's ID.
   */
